...
describe('p6-tabs', () => {
  const contentPage = `
  <p6-tabs>
    <p6-tab for="first">What is Lorem Ipsum?</p6-tab>
    <p6-tab for="second">Where does it come from?</p6-tab>
    <p6-tab for="third">Why do we use it?</p6-tab>
    <p6-tab for="fourth">Where can I get some?</p6-tab>

    <p6-tab-content id="first">
    ...
    <p6-tab-content id="third" active>
    ...
    <p6-tab-content id="fourth" title="Where can I get some?">
  ...
  it('fire a click event', async () => {
    ...
    const tab = await page.find('p6-tabs p6-tab[for="second"]');
  ...
  it('should change the active tab to second', async () => {
    ...
    const tabContent = await page.find('p6-tabs p6-tab-content:not([aria-hidden])');
    expect(tabContent.innerHTML.trim()).toBe(
      `
      Contrary to popular belief, Lorem Ipsum is not simply random text. 
      It has roots in a piece of classical Latin literature from 45 BC, 
      making it over 2000 years old. Richard McClintock, 
